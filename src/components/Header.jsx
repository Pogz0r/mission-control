  ...
  return (
    <header className="sticky top-0 z-10 flex flex-col gap-3 border-b border-zinc-800 bg-zinc-950/90 px-4 py-4 backdrop-blur sm:px-5 lg:flex-row lg:items-center lg:justify-between lg:px-6 lg:py-5">
      ...
      <div className="flex flex-wrap items-center gap-2 lg:gap-3">
        ...
        {actions}
        <button className="inline-flex items-center gap-2 rounded-2xl border border-zinc-800 bg-zinc-900 px-3 py-2 text-xs font-medium text-zinc-200 transition hover:border-zinc-700 hover:bg-zinc-800 lg:px-4 lg:py-2.5 lg:text-sm">
          <Pause className="h-4 w-4" />
          Pause
        </button>
        <button className="inline-flex items-center gap-2 rounded-2xl bg-violet-500 px-3 py-2 text-xs font-medium text-white transition hover:bg-violet-400 lg:px-4 lg:py-2.5 lg:text-sm">
          <Send className="h-4 w-4" />
          Ping Sage
        </button>
        <button className="flex h-10 w-10 items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900 text-zinc-400 transition hover:border-zinc-700 hover:text-white lg:h-11 lg:w-11">
